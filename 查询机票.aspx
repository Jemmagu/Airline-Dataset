<%@ Page Language="C#" AutoEventWireup="true" CodeFile="查询机票.aspx.cs" Inherits="订票" %>
...
<body>
    ...
    <div style="height: 892px; width: 1538px; ">
        ...
        <asp:Button ID="Button6" runat="server" OnClick="Button3_Click" Text="注册" />
        <asp:Button ID="Button5" runat="server" OnClick="Button1_Click" Text="查询" />
        <asp:Button ID="Button4" runat="server" OnClick="Button4_Click" Text="登陆" />
